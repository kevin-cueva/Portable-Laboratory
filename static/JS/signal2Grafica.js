am5.ready(function() {
    ...
    function generateChartData() {
      ...
      firstDate.setHours(0, 0, 0, 0);
        ...
        data.func2.forEach((element, index) => {
    ...
    var series = chart.series.push(am5xy.LineSeries.new(root, {
      ...
      stroke: "#FFFF00", //Amarillo, // Linea color
      tooltip: am5.Tooltip.new(root, {
        pointerOrientation: "horizontal",
        labelText: "{valueY}",
      })
    }));
    //Condifuracion de tipo de liena, color, ancho, etc
    //https://www-amcharts-com.translate.goog/docs/v5/charts/xy-chart/series/line-series/?_x_tr_sl=auto&_x_tr_tl=es&_x_tr_hl=es#Configuring_appearance
    ...
    signal[signal.length - 1].bullet = true;
    series.data.setAll(signal);
    ...
    function addData() {
      ...
      console.log(data.func2)
      var lastValue = lastDataItem.get("valueY");
      var newValue = data.func2[con];
      con = con+1;
      if(con ==data.func2.length) con=0;
